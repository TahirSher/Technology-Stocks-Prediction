# -*- coding: utf-8 -*-
"""(NVDA stock )Deep Learning Project Submission Date (08 May, 2022): Evaluation of Tree Based Ensemble Machine Learning Models in Predicting Stock Price Direction of Movement.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1DRf2Eo9-nXFtH4NksdWc3J7VAUC_V2Lz
"""
...
#reading the data
nvda = pd.read_csv('/content/drive/MyDrive/STOCK EXCHANGE DATASETS AND CODINGS/Technology Stock Forecasting Complete/Stock Exchange Research task/NVDA.csv')
nvda

#Technical Indicators
ema_26 = nvda['Close'].transform(lambda x:x.ewm(span=26).mean())
ema_26

ema_12 = nvda['Close'].transform(lambda x:x.ewm(span=12).mean())
ema_12
...
n=14
low_14=nvda['Low'].transform(lambda x:x.rolling(window=n).min())
high_14=nvda['High'].transform(lambda x:x.rolling(window=n).max())
k_percent=100*((nvda['Close']-low_14)/(high_14-low_14))

#Relative Strength Index (RSI)
nvda['RSI'] = ta.RSI(nvda['Close'], timeperiod=14)

#MACD, short for moving average convergence/divergence, is a trading indicator used in technical analysis of stock prices

nvda['macd'], nvda['macdsignal'], nvda['macdhist'] = ta.MACD(nvda['Close'], fastperiod=12, slowperiod=26, signalperiod=9)
...
nvda['WILL'] = ta.WILLR(nvda['High'], nvda['Low'], nvda['Close'], timeperiod=14)
nvda['MACD']=macdd
nvda['MACD_EMA']=ema_9_macd
nvda['STOCHOSI']=k_percent

nvda['ADXR'] = ta.ADXR(nvda['High'], nvda['Low'], nvda['Close'], timeperiod=10)
nvda['APO'] = ta.APO(nvda['Close'], fastperiod=12, slowperiod=26, matype=0)
nvda['aroondown'], nvda['aroonup'] = ta.AROON(nvda['High'], nvda['Low'], timeperiod=14)
nvda['AROONOSC'] = ta.AROONOSC(nvda['High'], nvda['Low'], timeperiod=14)
nvda['BOP'] = ta.BOP(nvda['Open'], nvda['High'], nvda['Low'], nvda['Close'])
nvda['CCI'] = ta.CCI(nvda['High'], nvda['Low'], nvda['Close'], timeperiod=14)
nvda['CMO']= ta.CMO(nvda['Close'], timeperiod=14)
nvda['DX']= ta.DX(nvda['High'], nvda['Low'], nvda['Close'], timeperiod=14)
nvda['macdext'], nvda['macdextsignal'], nvda['macdexthist'] = ta.MACDEXT(nvda['Close'], fastperiod=12, fastmatype=0, slowperiod=26, slowmatype=0, signalperiod=9, signalmatype=0)
nvda['macdfix'], nvda['macdfixsignal'], nvda['macdfixhist'] = ta.MACDFIX(nvda['Close'], signalperiod=9)

nvda['MINUS_DI'] = ta.MINUS_DI(nvda['High'], nvda['Low'], nvda['Close'], timeperiod=14)
nvda['MINUS_DM'] = ta.MINUS_DM(nvda['High'], nvda['Low'], timeperiod=14)
nvda['MOM'] = ta.MOM(nvda['Close'], timeperiod=10)
nvda['PLUS_DI'] = ta.PLUS_DI(nvda['High'], nvda['Low'], nvda['Close'], timeperiod=14)
nvda['PLUS_DM'] = ta.PLUS_DM(nvda['High'], nvda['Low'], timeperiod=14)
nvda['PPO'] = ta.PPO(nvda['Close'], fastperiod=12, slowperiod=26, matype=0)
nvda['ROC']= ta.ROC(nvda['Close'], timeperiod=10)
nvda['ROCP'] = ta.ROCP(nvda['Close'], timeperiod=10)
nvda['ROCR'] = ta.ROCR(nvda['Close'], timeperiod=10)
nvda['STOCHk'], nvda['STOCHd'] = ta.STOCH(nvda['High'], nvda['Low'], nvda['Close'], fastk_period=5, slowk_period=3,slowk_matype=0, slowd_period=3, slowd_matype=0)

nvda['STOCHFk'], nvda['STOCHFd'] = ta.STOCHF(nvda['High'], nvda['Low'], nvda['Close'], fastk_period=5, fastd_period=3, fastd_matype=0)
nvda['STOCHRSIk'], nvda['STOCHRSId'] = ta.STOCHRSI(nvda['Close'], timeperiod=14, fastk_period=5, fastd_period=3, fastd_matype=0)
nvda['TRIX']= ta.TRIX(nvda['Close'], timeperiod=30)
nvda['ULTOSC'] = ta.ULTOSC(nvda['High'], nvda['Low'], nvda['Close'], timeperiod1=7, timeperiod2=14, timeperiod3=28)

nvda['upperband'], nvda['middleband'], nvda['lowerband'] = ta.BBANDS(nvda['Close'], timeperiod=5, nbdevup=2, nbdevdn=2, matype=0)
nvda['DEMA'] = ta.DEMA(nvda['Close'], timeperiod=30)
nvda['EMA']= ta.EMA(nvda['Close'], timeperiod=30)
nvda['HT_TRENDLINE'] = ta.HT_TRENDLINE(nvda['Close'])
nvda['KAMA'] = ta.KAMA(nvda['Close'], timeperiod=30)
nvda['MA'] = ta.MA(nvda['Close'], timeperiod=30, matype=0)
nvda['MIDPOINT'] = ta.MIDPOINT(nvda['Close'], timeperiod=14)
nvda['MIDPRICE'] = ta.MIDPRICE(nvda['High'], nvda['Low'], timeperiod=14)
nvda['SAR'] = ta.SAR(nvda['High'], nvda['Low'], acceleration=0, maximum=0)
nvda['SMA'] = ta.SMA(nvda['High'], timeperiod=30)
nvda['T3'] = ta.T3(nvda['Close'], timeperiod=30, vfactor=0)
nvda['TEMA'] = ta.TEMA(nvda['Close'], timeperiod=30)
nvda['TRIMA']= ta.TRIMA(nvda['Close'], timeperiod=30)
nvda['WMA'] = ta.WMA(nvda['Close'], timeperiod=30)
nvda['ATR'] = ta.ATR(nvda['High'], nvda['Low'], nvda['Close'], timeperiod=14)
nvda['NATR']= ta.NATR(nvda['High'], nvda['Low'], nvda['Close'], timeperiod=14)
nvda['TRANG'] = ta.TRANGE(nvda['High'], nvda['Low'], nvda['Close'])
nvda['AVGPRICE']= ta.AVGPRICE(nvda['Open'],nvda['High'], nvda['Low'],nvda['Close'])
nvda['MEDPRICE'] = ta.MEDPRICE(nvda['High'], nvda['Low'])
nvda['TYPPRICE'] = ta.TYPPRICE(nvda['High'], nvda['Low'], nvda['Close'])
nvda['WCLPRICE'] = ta.WCLPRICE(nvda['High'], nvda['Low'], nvda['Close'])
nvda['HT_DCPERIOD'] = ta.HT_DCPERIOD(nvda['Close'])
nvda['HT_DCPHASE'] = ta.HT_DCPHASE(nvda['Close'])
nvda['inphase'], nvda['quadrature'] = ta.HT_PHASOR(nvda['Close'])
nvda['sine'], nvda['leadsine'] = ta.HT_SINE(nvda['Close'])
nvda['HT_TRENDMODE'] = ta.HT_TRENDMODE(nvda['Close'])
...
close=nvda['Close'].transform(lambda x:x.shift(1)<x)
nvda['Prediction']=close*1

#data cleaning
nvda=nvda.dropna()

nvda_X=nvda.drop(columns=['Prediction','Date'])
nvda_y=nvda['Prediction']

# defining train-test data set
X_train = nvda_X[:int(nvda_X.shape[0]*0.7)]
X_test = nvda_X[int(nvda_X.shape[0]*0.7):]
y_train = nvda_y[:int(nvda_X.shape[0]*0.7)]
y_test = nvda_y[int(nvda_X.shape[0]*0.7):]
...
plt.xticks(range(TestingRecords), nvda.tail(TestingRecords)['Date'])
...
import numpy as np
Last10DaysPrices=np.array([195.15,199.02,187.88,184.15,197.82,185.47,195.33,196.02,203.34,188.44])
